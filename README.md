As I've recently received some Ghost Atto receivers, which were already flashed with ExpressLRS, I was looking for the firmware files to flash them back into those receivers.
